...
module.exports = function (eleventyConfig) {
    ...
    // Responsive images (AVIF/WebP at multiple widths) are generated by scripts/generate-images.js
    // into .image-cache/, not by Eleventy itself — kept outside Eleventy's own build so the cache
    // persists across dev-server rebuilds (see scripts/generate-images.js for why).
    eleventyConfig.addPassthroughCopy({ ".image-cache": "images" });
    eleventyConfig.addWatchTarget(".image-cache");
